...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: "iphone-webkit",
      testMatch: /(?:accessibility|merchant-webkit|market-freshness|public-release|browser-smoke|public-private-continuity|overlay-contract|modal-motion|private-manifest-security)\.spec\.ts/,
