...
export default defineConfig({
  ...
  testMatch: ['private-components.spec.ts', 'ux-primitives.spec.ts', 'qr-freshness.spec.ts', 'relay-earn.spec.ts', 'relay-startup.spec.ts', 'modal-ownership.spec.ts', 'merchant-feedback.spec.ts', 'relay-recovery.spec.ts'],
