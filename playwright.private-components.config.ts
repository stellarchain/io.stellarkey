...
export default defineConfig({
  ...
  testMatch: ['private-components.spec.ts', 'private-direct.spec.ts', 'ux-primitives.spec.ts', 'qr-freshness.spec.ts', 'modal-ownership.spec.ts', 'merchant-feedback.spec.ts', 'private-recovery.spec.ts', 'swap-trustline.spec.ts'],
