...
## Decision
Build a greenfield fixed-asset shielded note pool on Soroban using Protocol 25 BN254 Groth16 host functions, width-4 Poseidon2, RFC 9180 HPKE, and independent persistent on-chain archive records for disaster recovery.
