...
#[test]
fn protocol_v1_note_round_trips_asset_index_and_diversifier_in_exact_128_byte_layout() {
    ...
    assert_eq!(&serialized[113..117], &[1, 2, 3, 4]);
...
fn protocol_v1_note_rejects_nonzero_reserved_tail() {
    ...
    let mut rho = [0u8; 32];
    rho[31] = 9;
    let note = NotePlaintext::new(1, 0, [0; 4], owner, rho, "").unwrap();
