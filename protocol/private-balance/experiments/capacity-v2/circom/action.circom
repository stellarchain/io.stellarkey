// EXPERIMENT ONLY: v1 action constraints adapted for the capacity-v2 prototype.
pragma circom 2.1.6;

include "../../../circuits/circom/poseidon2.circom";
include "../../../circuits/circom/owner.circom";
include "../../../circuits/circom/note.circom";
include "../../../circuits/circom/nullifier.circom";
...
template CapacityAction(INNER, OUTER) {
