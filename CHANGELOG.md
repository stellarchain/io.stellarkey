...
- Bound multi-signature authority reads to SDF Horizon so a custom endpoint cannot hide retained signers, and made emergency reset revoke signing authority and erase the vault before fallible browser-storage cleanup.
