...
test('all authoritative release markers agree on version 1.0.0', () => {
  ...
  assert.match(brand, /APPLICATION_VERSION = "1\.0\.0"/);
  assert.match(security, /latest `1\.0\.x` release/i);
  assert.match(readme, /current release is `1\.0\.0`/i);
