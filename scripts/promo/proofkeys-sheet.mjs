...
const M = JSON.parse(readFileSync("/tmp/promo/proofkeys.json", "utf8"));
...
const p = await b.newPage({ viewport: { width: 1160, height: 1700 }, deviceScaleFactor: 2 });
...
await p.screenshot({ path: "/tmp/promo/proofkeys-sheet.png", fullPage: true });
await b.close();
console.log("ok");
