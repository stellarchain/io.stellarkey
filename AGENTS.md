...
- Keep nested browser-protocol, required synthetic private UI/component, overlay, and manifest gates in shared application CI/release verification. Check fixture cleanup before and after production builds. Rust/circuit jobs and human assistive-technology/physical-device evidence remain separately required; a passing application command does not replace them.
