...
The September 14, 2026 whitepaper describes application release **1.0.2**,
continuing the stable **1.0.0** application baseline and Protocol **V2**,
with implementation pinned to the immutable release tag `v1.0.2`. Only current-format application state
