...
- The same durable relay ownership/preflight rule was added to `AGENTS.md`; `CHANGELOG.md` records the user-visible fixes under Unreleased. Integration into the running main worktree awaits the user's branch choice; no remote push or deployment has occurred.
