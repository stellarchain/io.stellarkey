...
- Review and record the [repository security settings](./production-deployment.md#repository-security-settings); checked-in workflows cannot prove that GitHub dashboard protections remain enabled.
