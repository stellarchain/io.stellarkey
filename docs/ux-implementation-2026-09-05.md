...
- Logical commits and integration are deferred to the integration choice. Working changes and Unreleased notes remain together in the feature worktree; no commit, merge, push, tag or deployment has occurred. The main checkout and unrelated user documents remain untouched.
