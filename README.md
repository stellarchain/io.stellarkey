...
account through the selected RPC. StellarKey 1.0.0 is the starting application
...
The current release is `1.0.3`, continuing the stable `1.0.0` application baseline and Protocol V2. Every build embeds the full 40-character Git
