...
export default function AboutPage() {
  return (
    ...
    >
        ...
        <section id="about-private-payments"><h2><DocShieldDots />Private Payments (preview)</h2><p>Release 1.3.0 adds Private Payments, a testnet-only preview that lives inside the same wallet rather than a separate app: a private balance beside your public one for configured XLM and USDC. The amount, the recipient, and the memo of a private transfer stay encrypted, while money moving in or out, network fees paid by your Stellar account, and timing stay public. Proofs are created on this device with no application backend, and recovery works from the wallet&apos;s own phrase. Privacy grows with more independent activity; it is context, not a guarantee. The <a href={PUBLIC_ROUTES.private}>Private Payments explainer</a> covers the design, the limits, and the release gates before Mainnet.</p><p>The brand tells the same story: one mark, three duties. The official Stellar symbol, always at its own line weight, sits inside a lock for the wallet you own, a shield for the payments you keep private, and a receipt for the sales you can prove.</p></section>
