...
const title = `${BRAND_NAME}: a Stellar wallet with a point of sale in it`;
const description =
  "A self-custody Stellar wallet and a point of sale in one app. The vault is encrypted in " +
  "your browser, transactions are reviewed before signing, and merchant records stay local. " +
  "Stellar payments and network request metadata remain public or visible to the services you use.";
